        ...
        <div className = "skills-sub">
            ...
            <div className={classes.root}>
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={3}>
                    <label><Paper className={classes.paper}><input type="checkbox" value={checked3} onChange={() => setChecked3(!checked3)} {...checked3 == true ? add("https://raw.githubusercontent.com/devicons/devicon/master/icons/electron/electron-original.svg") : remove("https://raw.githubusercontent.com/devicons/devicon/master/icons/electron/electron-original.svg")}/><Item img =  "https://raw.githubusercontent.com/devicons/devicon/master/icons/electron/electron-original.svg" /></Paper></label>
                    </Grid>
                    <Grid item xs={3}>
                    <label><Paper className={classes.paper}><input type="checkbox" value={checked4} onChange={() => setChecked4(!checked4)} {...checked4 == true ? add("https://symfony.com/logos/symfony_black_03.svg") : remove("https://symfony.com/logos/symfony_black_03.svg")}/><Item img =  "https://symfony.com/logos/symfony_black_03.svg" /></Paper></label>
                    </Grid>
                </Grid>
            </div>
            ...
            <div className={classes.root}>
                <Grid container spacing={3}>
                    <Grid item xs={3}>
                    <label><Paper className={classes.paper}><input type="checkbox" value={checked9} onChange={() => setChecked9(!checked9)} {...checked9 == true ? add("https://cdn.quasar.dev/logo/svg/quasar-logo.svg") : remove("https://cdn.quasar.dev/logo/svg/quasar-logo.svg")}/><Item img = "https://cdn.quasar.dev/logo/svg/quasar-logo.svg" /></Paper></label>
                    </Grid>
                </Grid>
            </div>
